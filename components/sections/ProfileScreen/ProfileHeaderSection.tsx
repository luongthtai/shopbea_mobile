...
export default function ProfileHeaderSection() {
    ...
    const onNavigateToSettingScreen = () => navigation.navigate('setting')
    ...
    return (
        <View style={styles.root}>
            <View style={styles.container}>
                ...
                <TouchableOpacity onPress={onNavigateToSettingScreen}><Ionicons name='settings-outline' size={20} /></TouchableOpacity>
            </View>

            <TouchableOpacity style={styles.more_freeship}>
                <View style={{ gap: 4 }}>
                    <Text style={{ fontWeight: 600, fontSize: 14 }}>Use More Free Shipping</Text>
                    <Text style={{ color: COLORS['Grey-Grey-1'], fontSize: 12 }}>Subscribe now to enjoy additional free shipping.</Text>
                </View>
